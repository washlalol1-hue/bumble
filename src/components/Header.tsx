...
export function Header({ accountCount, isRunning, activePlatform, onPlatformChange }: HeaderProps) {
  return (
      ...
      <div className="flex items-center justify-between px-6 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-dark-500 uppercase tracking-wider">Mr d</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          {accountCount > 0 && (
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-dark-800 border border-dark-700 rounded-lg">
              ...
              <span className="text-sm font-bold text-brand-400">{accountCount}</span>
            </div>
          )}
